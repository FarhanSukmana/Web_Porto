  ...
  return (
    <div className='flex flex-col items-center'>
        <div className='max-w-[800px] mx-auto px-4 md:w-full md:flex md:flex-col md:items-center md:p-8'>
            <h2 className='text-5xl pb-4 text-blue-800 dark:text-teal-600'>Muhammad Farhan Sukmana</h2>
            <h3 className='text-2xl py-2 text-center dark:text-gray-300'>
              <TypeAnimation
                sequence ={[
        ...
        <div className=' relative mx-auto bg-gradient-to-b from-blue-800 dark:from-teal-600 rounded-full w-80 h-80 md:h-96 md:w-96' >
            <img src={foto} alt="" className='object-cover cover-image rounded-full' />
        </div>
        <div className='text-4xl flex gap-12 justify-center text-gray-600 dark:text-gray-400'>
